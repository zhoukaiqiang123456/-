$(function () {
    ...
    var timerFn = function () {
        ...
        $(".banner ul").stop().animate({"left": "" + moveLeft + "px"}, 500)
    };
    ...
    var json0 = {"width": 114, "height": 206, "left": -200, "top": 224, "z-index": 98};
    var json1 = {"width": 149, "height": 269, "left": 8, "top": 132, "z-index": 99};
    var json2 = {"width": 196, "height": 353, "left": 216, "top": 40, "z-index": 100};
    var json3 = {"width": 149, "height": 269, "left": 471, "top": 132, "z-index": 99};
    var json4 = {"width": 114, "height": 206, "left": 726, "top": 224, "z-index": 98};
    var timer02 = null;
    var appFn = function () {
    ...
    var jsBwLi0 = {"width": 307, "height": 155, "left": -24, "top": 56};
    var jsBwLi1 = {"width": 444, "height": 187, "left": 0, "top": 41};
    var jsBwLi2 = {"width": 533, "height": 225, "left": 70, "top": 22};
    var jsBwLi3 = {"width": 640, "height": 270, "left": 170, "top": 0};
    var jsBwLi4 = {"width": 533, "height": 225, "left": 377, "top": 22};
    var jsBwLi5 = {"width": 444, "height": 187, "left": 528, "top": 41};
    var jsBwLi6 = {"width": 307, "height": 155, "left": 698, "top": 56};
    var nowimg = 0;
    var lock = false;
    ...
    var padAppFn = function () {
        ...
        $(".padAppIn_ul ul").stop().animate({"left": moveLeft + "px"}, 500)
    };
    ...
    var padUiFn = function () {
        ...
        $(".padUiIn_ul ul").stop().animate({"left": moveLeft + "px"}, 500)
    };
    ...
    //        banNowImg = 0
    //    }
    //    $(".padBwImg").attr("src", "images/padBwImg0" + banNowImg + ".jpg");
    ...
    //        $(".maoni p").css("background-image", "url(images/padBwImg0" + banNowImg + ".jpg)");
    ...
    //        mbanNowImg = 0
    //    }
    //    $(".mobBwImg").attr("src", "images/mobBwImg0" + mbanNowImg + ".jpg");
    ...
    //        $(".mobBanwAdd p").css("background-image", "url(images/mobBwImg0" + mbanNowImg + ".jpg)");
    ...
    //UI-icon特效
    (function (){
        var imgWidth = $(".UI-icon ul li").width() * 2;
        var num = 0;
        var timer;
        timer = setInterval(autoplay, 2000);
        function autoplay() {
            num++;
            $(".UI-icon ul").animate({"left": -num * imgWidth}, 1000);
            if (num == 5) {
                $(".UI-icon ul").animate({"left": 0}, 9);
                num = 0;
            }
        }

        $(".UI-icon ul li").on("mouseenter", function () {
            clearInterval(timer);
        });
        $(".UI-icon ul li").on("mouseleave", function () {
            timer = setInterval(autoplay, 2000);
        });
    })();

    //3Dmax 图片特效
    $(".three-dimensional ul li").on("mouseenter", function () {
        $(this).stop().animate({"opacity": 1}, 500).siblings().stop().animate({"opacity": 0.5}, 1000);
        $(this).find("p").animate({"height": 0}, 0).animate({"height": 40}, 500);
        $(this).find("img").animate({"height": 0}, 0).animate({"height": "100%"}, 500);
    });
    $(".three-dimensional ul li").on("mouseleave", function () {
        $(".three-dimensional ul li").animate({"opacity": 1}, 0);
    });
});